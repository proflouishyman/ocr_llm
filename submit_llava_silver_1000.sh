...
#SBATCH --job-name=LLaVA_train_silver_1000
...
#SBATCH --output=./slurm_logging/llava_training_silver_1000_%j.out
#SBATCH --error=./slurm_logging/llava_training_silver_1000_%j.err
...
srun bash train_llava_silver_1000.sh
