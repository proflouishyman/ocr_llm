...
#SBATCH --job-name=BART_train_gold_100
...
#SBATCH --output=./slurm_logging/ocr_training_gold_100_%j.out
#SBATCH --error=./slurm_logging/ocr_training_gold_100_%j.err
...
TRAIN_DATASET="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/gold_100/train"
