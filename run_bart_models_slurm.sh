...
#SBATCH --output=./slurm_logging/bart_models_test_%j.out
#SBATCH --error=./slurm_logging/bart_models_test_%j.err
...
srun python /data/lhyman6/OCR/scripts/ocr_llm/run_bart_models.py
