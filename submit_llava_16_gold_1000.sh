...
#SBATCH --output=./slurm_logging/llava_16_training_gold_1000_%j.out
#SBATCH --error=./slurm_logging/llava_16_training_gold_1000_%j.err
...
srun bash train_llava_16_gold_1000.sh
