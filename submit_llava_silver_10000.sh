...
#SBATCH --job-name=LLaVA_train_silver_10000
...
#SBATCH --output=./slurm_logging/llava_training_silver_10000_%j.out
#SBATCH --error=./slurm_logging/llava_training_silver_10000_%j.err
