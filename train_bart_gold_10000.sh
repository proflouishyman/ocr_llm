...
#SBATCH --job-name=BART_train_gold_10000
...
#SBATCH --output=./slurm_logging/ocr_training_gold_10000_%j.out
#SBATCH --error=./slurm_logging/ocr_training_gold_10000_%j.err
...
TRAIN_DATASET="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/gold_10000/train"
VALIDATION_DATASET="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/gold_10000/val"
TEST_DATASET="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/gold_10000/test"
OUTPUT_DIR="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/tuning_results_gold_10000"
