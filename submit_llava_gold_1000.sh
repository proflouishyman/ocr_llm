...
#SBATCH --job-name=LLaVA_train_gold_1000
...
#SBATCH --output=./slurm_logging/llava_training_gold_1000_%j.out
#SBATCH --error=./slurm_logging/llava_training_gold_1000_%j.err
...
srun bash train_llava_gold_1000.sh
