...
log_metrics() {
    LOG_FILE="/data/lhyman6/OCR/scripts/ocr_llm/slurm_logging/ocr_job/system_metrics_silver_100.log"
...
deepspeed --num_gpus=$NUM_GPUS train_mem.py \
    ...
    --version v1 \
    --data_path /scratch4/lhyman6/OCR/OCR/ocr_llm/work/llava/silver_100/silver_100.json \
    ...
    --fp16 False \
    --bf16 True \
    --output_dir /scratch4/lhyman6/OCR/OCR/ocr_llm/work/llava_16/silver_100/checkpoints/llava-hf/llava-v1.6-mistral-7b-hf-task \
    --num_train_epochs 15 \
    ...
    --run_name "llava_16_silver_100_training"
