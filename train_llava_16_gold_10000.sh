...
deepspeed train_mem.py \
    ...
    --version v1 \
    --data_path /scratch4/lhyman6/OCR/OCR/ocr_llm/work/llava/gold_10000/gold_10000.json \
    ...
    --fp16 False \
    --bf16 True \
    --output_dir /scratch4/lhyman6/OCR/OCR/ocr_llm/work/llava_16/gold_10000/checkpoints/llava-hf/llava-v1.6-mistral-7b-hf-task-lora \
    --num_train_epochs 15 \
