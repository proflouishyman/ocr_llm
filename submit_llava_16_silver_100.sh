...
#SBATCH --output=./slurm_logging/llava_16_training_silver_100_%j.out
#SBATCH --error=./slurm_logging/llava_16_training_silver_100_%j.err
...
srun bash train_llava_16_silver_100.sh
