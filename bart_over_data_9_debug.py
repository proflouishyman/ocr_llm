...
#works but has model errors i think. will try to see if the other models work better.
...
def main():
    ...
    combined_output_path = os.path.join(args.output_dir, 'combined_output.csv')
