...
#SBATCH --output=./slurm_logging/llava_16_training_silver_1000_%j.out
#SBATCH --error=./slurm_logging/llava_16_training_silver_1000_%j.err
...
srun bash train_llava_16_silver_1000.sh
