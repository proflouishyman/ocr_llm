...
#SBATCH --job-name=BART_train_gold_1000
...
#SBATCH --output=./slurm_logging/ocr_training_gold_1000_%j.out
#SBATCH --error=./slurm_logging/ocr_training_gold_1000_%j.err
...
TRAIN_DATASET="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/gold_1000/train"
VALIDATION_DATASET="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/gold_1000/val"
TEST_DATASET="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/gold_1000/test"
OUTPUT_DIR="/scratch4/lhyman6/OCR/OCR/ocr_llm/work/tuning_results_gold_1000"
