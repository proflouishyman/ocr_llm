...
log_metrics() {
    LOG_FILE="/data/lhyman6/OCR/scripts/ocr_llm/slurm_logging/ocr_job/system_metrics_silver_10000.log"
...
deepspeed --num_gpus=$NUM_GPUS train_mem.py \
    ...
    --version v1 \
    --data_path /scratch4/lhyman6/OCR/OCR/ocr_llm/work/llava/silver_10000/silver_10000.json \
    ...
    --run_name "llava_16_silver_10000_training"
