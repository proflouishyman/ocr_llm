...
log_metrics() {
    LOG_FILE="/data/lhyman6/OCR/scripts/ocr_llm/slurm_logging/ocr_job/system_metrics_gold_100.log"
...
deepspeed --num_gpus=$NUM_GPUS train_mem.py \
    ...
    --fp16 False \
    --bf16 True \
    --output_dir /scratch4/lhyman6/OCR/OCR/ocr_llm/work/llava_16/gold_100/checkpoints/llava-hf/llava-v1.6-mistral-7b-hf-task \
    --num_train_epochs 15 \
    ...
    --run_name "llava_16_gold_100_training"
