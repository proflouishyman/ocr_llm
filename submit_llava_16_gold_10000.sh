...
#SBATCH --output=./slurm_logging/llava_16_training_gold_10000_%j.out
#SBATCH --error=./slurm_logging/llava_16_training_gold_10000_%j.err
...
srun bash train_llava_16_gold_10000.sh
