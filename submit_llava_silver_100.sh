...
#SBATCH --job-name=LLaVA_train_silver_100
...
#SBATCH --output=./slurm_logging/llava_training_silver_100_%j.out
#SBATCH --error=./slurm_logging/llava_training_silver_100_%j.err
...
srun bash train_llava_silver_100.sh
